// WORLD FOOD ATLAS - Verified Permanent High-Res Asset Version
const foodDB = [
    // 한식 (K-Food)
    {
        id:'k1', cat:'한식', subCat:'밥/죽', name:'비빔밥', 
    ...
    {
        id:'k2', cat:'한식', subCat:'정통 고기요리', name:'잡채', 
        info:'임금님의 입맛을 사로잡은 연회 요리', 
        img:'https://images.unsplash.com/photo-1534422298391-e4f8c170db06?auto=format&fit=crop&q=80&w=1000', 
        desc:'당면과 갖은 채소, 고기를 한데 볶아 만드는 정성 가득한 요리입니다. 한국 명절의 대명사입니다.'
    },
    {
        id:'k3', cat:'한식', subCat:'찌개/찜', name:'김치찌개', 
        info:'한국인의 영원한 소울 푸드', 
        img:'https://images.unsplash.com/photo-1583216075404-48727f04b7ca?auto=format&fit=crop&q=80&w=1000', 
        desc:'잘 익은 김치와 고소한 돼지고기가 어우러진 깊은 맛의 한국 대표 찌개입니다.'
    },
    {
        id:'k4', cat:'한식', subCat:'정통 고기요리', name:'불고기', 
    ...
    {
        id:'k5', cat:'한식', subCat:'찌개/찜', name:'갈비찜', 
    ...
    {
        id:'k6', cat:'한식', subCat:'면류/분식', name:'파전', 
        info:'바삭한 식감 속 해산물의 향연', 
        img:'https://images.unsplash.com/photo-1512484776495-a09d92e87c3b?auto=format&fit=crop&q=80&w=1000', 
        desc:'신선한 파와 각종 해산물을 듬뿍 넣어 지져낸 고소한 한국식 전입니다.'
    },

    // 양식 (Western)
    {
        id:'w1', cat:'양식', subCat:'스테이크', name:'스테이크', 
        info:'부드러움의 정점에 선 육류 요리', 
        img:'https://images.unsplash.com/photo-1546241072-48010ad28c2c?auto=format&fit=crop&q=80&w=1000', 
        desc:'소량만 추출되는 고품격 안심 부위를 정성껏 시어링하여 제공하는 양식의 꽃입니다.'
    },
    {
        id:'w2', cat:'양식', subCat:'피자/파스타', name:'피자', 
        info:'나폴리의 자부심을 담은 한 입', 
        img:'https://images.unsplash.com/photo-1574071318508-1cdbad80ad38?auto=format&fit=crop&q=80&w=1000', 
        desc:'바질, 모짜렐라, 토마토로 이탈리아 국기를 상징한 정통 나폴리 스타일의 피자입니다.'
    },
    {
        id:'w3', cat:'양식', subCat:'파스타', name:'파스타', 
        info:'태양의 맛을 담은 이탈리아 요리', 
        img:'https://images.unsplash.com/photo-1473093226795-af9932fe5856?auto=format&fit=crop&q=80&w=1000', 
        desc:'신선한 재료와 파스타 면이 만나 무궁무진한 맛을 만들어내는 이탈리아 대표 요리입니다.'
    },
    {
        id:'w6', cat:'양식', subCat:'피자/파스타', name:'라자냐', 
        info:'층층이 쌓인 오븐의 예술', 
        img:'https://images.unsplash.com/photo-1574894709920-11b28e734740?auto=format&fit=crop&q=80&w=1000', 
        desc:'파스타 면과 라구 소스, 치즈를 겹겹이 쌓아 깊은 풍미를 자랑하는 요리입니다.'
    },

    // 일식 (Japanese)
    {
        id:'j1', cat:'일식', subCat:'초밥/사시미', name:'초밥', 
    ...
    {
        id:'j2', cat:'일식', subCat:'초밥/사시미', name:'사시미', 
        info:'바다의 신선함을 투명하게 담다', 
        img:'https://images.unsplash.com/photo-1553621042-f6e147245754?auto=format&fit=crop&q=80&w=1000', 
        desc:'각종 해산물을 조리하지 않고 썰어내어 재료 본연의 맛을 극대화한 요리입니다.'
    },
    {
        id:'j4', cat:'일식', subCat:'덮밥/라멘', name:'라멘', 
        info:'진하고 고소한 일본의 맛', 
    ...
    // 중식 (Chinese)
    {
        id:'c1', cat:'중식', subCat:'요리류', name:'베이징덕', 
        info:'황제의 요리로 불리는 정통 오리 구이', 
        img:'https://images.unsplash.com/photo-1563245394-878f13e1d328?auto=format&fit=crop&q=80&w=1000', 
        desc:'바삭하게 구워진 껍질이 일품인 중국 베이징 최고의 보양 및 미식 요리입니다.'
    },
    {
        id:'c2', cat:'중식', subCat:'요리류', name:'만두(딤섬)', 
        info:'피 속 가득 찬 육즙의 축제', 
        img:'https://images.unsplash.com/photo-1541696490-8744a5dbadbb?auto=format&fit=crop&q=80&w=1000', 
        desc:'한 번의 젓가락질로 터지는 따뜻하고 진한 육즙이 매력적인 중국 정통 만두입니다.'
    },

    // 디저트 (Dessert)
    {
        id:'d1', cat:'디저트', subCat:'케이크/쿠키', name:'티라미수', 
        info:'나를 행복하게 끌어올리는 맛', 
        img:'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?auto=format&fit=crop&q=80&w=1000', 
        desc:'에스프레소와 부드러운 마스카포네 치즈가 만나 쌉쌀하면서도 달콤한 하모니를 이룹니다.'
    },
    {
        id:'d6', cat:'디저트', subCat:'케이크/쿠키', name:'마카롱', 
        info:'입안에 퍼지는 작은 사치', 
...
document.addEventListener('DOMContentLoaded', () => {
        ...
        grid.innerHTML = items.map(item => `
            <div class="p-card" data-id="${item.id}">
                ...
                <div class="p-info">
                    ...
                    <div class="p-btn-view">도감 상세 정보 열기</div>
                </div>
            </div>
        `).join('');
    };
    ...
    const showDetail = (id, saveState = true) => {
        ...
        document.getElementById('d-desc-target').innerHTML = `<strong>[푸드 아카이브 요약]</strong><br>${item.info}<br><br><strong>[도감 상세 설명]</strong><br>${item.desc}`;
